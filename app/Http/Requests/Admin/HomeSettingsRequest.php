...
class HomeSettingsRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'slides.*.mobile_image_file.image' => 'فایل تصویر موبایل بنر معتبر نیست.',
            'slides.*.mobile_image_file.mimes' => 'فرمت تصویر موبایل باید JPG، PNG یا WebP باشد.',
            'slides.*.mobile_image_file.max' => 'حجم تصویر موبایل نباید بیشتر از ۱۰ مگابایت باشد.',
            'slides.*.mobile_upload_token.uuid' => 'آپلود تصویر موبایل کامل نشده است؛ تصویر را دوباره انتخاب کنید.',
