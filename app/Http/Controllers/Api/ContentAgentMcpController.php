    ...
    private function tools(): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Run a safe read-only GraphQL query across PlayNexus games, studios, platforms, products, content, collections, categories and cached Game Radar. Prefer this for relational discovery/context, then use dedicated MCP action tools for writes.',
                'inputSchema' => [
                    'type' => 'object',
                    'properties' => [
                        'query' => [
