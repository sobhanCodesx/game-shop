    ...
    private function definitions(): array
    {
        return [
            ...
            'video' => [
                ...
                'tool' => 'create_video',
                'fields' => [
                    ['key' => 'title', 'label' => 'عنوان ویدیو', 'type' => 'text', 'required' => true, 'max' => 160],
                    ['key' => 'game_id', 'label' => 'بازی مرتبط', 'type' => 'entity', 'source' => 'game'],
                    ['key' => 'playlist_ids', 'label' => 'کالکشن‌ها', 'type' => 'multi_entity', 'source' => 'collection', 'default' => []],
                    ['key' => 'excerpt', 'label' => 'توضیح کوتاه', 'type' => 'long_text', 'max' => 500],
                    ['key' => 'body', 'label' => 'متن کامل', 'type' => 'long_text', 'max' => 100000],
                    ['key' => 'featured', 'label' => 'ویژه باشد؟', 'type' => 'boolean', 'default' => false],
