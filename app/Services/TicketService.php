...
class TicketService
{
    public function create(User $customer, User $creator, ?OrderItem $item, ?string $subject, string $message, ?Product $product = null, string $type = 'support', array $attachments = []): Ticket
    {
        $ticket = DB::transaction(function () use ($customer, $creator, $item, $subject, $message, $product, $type, $attachments) {
