        ...
        <StorefrontLayout>
            ...
            <main className="mx-auto max-w-7xl px-3 py-7 sm:px-5 sm:py-10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-black sm:text-3xl">
                                استودیوها و شرکت‌های بازی‌سازی
                            </h1>
                            <p className="mt-1 text-sm text-[var(--store-muted)]">
                                سازندگان بازی و تمام کانال‌های مرتبط با آن‌ها را
                                کشف کنید.
                            </p>
                        </div>
                    </div>
                ...
                {studios.data.length ? (
                        ...
                        {studios.data.map((studio) => (
                            ...
                            >
                                <div className="relative h-36 overflow-hidden bg-slate-950">
                                    ...
                                    <Avatar className="absolute -bottom-0 right-4 size-16 border-4 border-[var(--store-panel)] shadow-xl">
                                        {studio.logo_url && (
                                            <Avatar.Image
                                ...
                                <div className="p-4 pt-5">
                                    <h2 className="font-black group-hover:text-indigo-400">
                                        {studio.name}
                                    </h2>
                                    <p className="mt-2 line-clamp-2 min-h-10 text-xs leading-5 text-[var(--store-muted)]">
                                        {studio.description ||
                                            "مشاهده کانال‌ها و بازی‌های این استودیو"}
                                    </p>
                                    <div className="mt-4 flex items-center gap-3 text-[11px] font-bold">
                                        ...
                                        <span className="text-violet-400">
                                            {studio.collections_count.toLocaleString(
                                                "fa-IR",
                                            )}{" "}
                                            کالکشن
                                        </span>
                    ...
                    <div className="rounded-3xl border border-dashed border-[var(--store-border)] p-16 text-center text-[var(--store-muted)]">
                        استودیوی فعالی برای نمایش وجود ندارد.
                    </div>
                )}
