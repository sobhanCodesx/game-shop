...
function FeedItemComponent({
    ...
    return (
        <article className="pn-feed-card pn-deferred-zone overflow-hidden border-y border-[var(--store-border)] shadow-[0_14px_45px_-34px_rgba(0,0,0,.8)] sm:rounded-3xl sm:border">
