...
export const authInput =
    "h-14 w-full rounded-2xl border border-white/10 bg-white/[.055] px-4 text-sm text-white outline-none transition placeholder:text-slate-600 hover:border-white/20 focus:border-violet-400 focus:bg-white/[.08] focus:ring-4 focus:ring-violet-500/10";
export const authButton =
    "flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-l from-violet-600 via-indigo-600 to-blue-600 text-sm font-black text-white shadow-xl shadow-indigo-950/40 transition hover:-translate-y-0.5 hover:shadow-indigo-500/20 disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-50";
...
export default function AuthShell({
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto grid min-h-screen max-w-[1440px] lg:grid-cols-[.95fr_1.05fr]">
                ...
                <section className="flex min-h-screen items-center justify-center px-5 py-8 sm:px-8">
                    <div className="w-full max-w-[470px]">
                        ...
                        <div className="mb-7">
                            ...
                            <h1 className="mt-3 text-3xl font-black tracking-tight sm:text-[2.15rem]">
                                {title}
                            </h1>
                        ...
                        <div className="rounded-[30px] border border-white/[.08] bg-[#0b1020]/85 p-5 shadow-[0_30px_80px_rgba(0,0,0,.35)] backdrop-blur-2xl sm:p-8">
                            {children}
                        </div>
